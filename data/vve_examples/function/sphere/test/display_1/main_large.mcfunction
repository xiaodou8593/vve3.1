#vve_examples:sphere/test/display_1/main_large

function vve_examples:dice_6/_get
# 运动学迭代
execute as 0-0-0-0-0 run function vve:object/_iter_motion
# 介质探测
execute as 0-0-0-0-0 run function vve_examples:sphere/test/display_1/_iter_cpoints_large
# 力学迭代
execute as @e[tag=vve_examples_sphere,tag=test,limit=1] run function vve_examples:sphere/test/display_1/gravity
# 介质响应
