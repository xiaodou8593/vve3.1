#vve_examples:sphere/test/display_1/start
# 需要安装math3.1_gelib

function vve:_consts
function vve_examples:sphere/init
...
# 生成测试程序实体
execute as @e[tag=math_marker,limit=1] run function vve:test_coord/_topos
data modify storage vve_examples:io input set from storage vve_examples:class sphere_plate
function vve_examples:sphere/_proj
...
execute at @e[tag=math_marker,limit=1] run function vve_examples:sphere/_new
tag @e[tag=result,limit=1] add test
#tag @e[tag=result,limit=1] remove vve_examples_sphere

execute as @e[tag=result,limit=1] run function marker_control:data/_get

# 设置测试程序主函数和销毁函数
data modify storage marker_control:io result.tick_func set value "vve_examples:sphere/test/display_1/main"
data modify storage marker_control:io result.del_func set value "vve_examples:sphere/test/display_1/end"
...
function vve_examples:sphere/test/display_1/summon_5