...
# 选择贴合面
execute if score cos int = sstemp_d1 int run return run function vve_examples:dice_10/regular/surface_1
execute if score cos int = sstemp_d2 int run return run function vve_examples:dice_10/regular/surface_2
execute if score cos int = sstemp_d3 int run return run function vve_examples:dice_10/regular/surface_3
execute if score cos int = sstemp_d4 int run return run function vve_examples:dice_10/regular/surface_4
execute if score cos int = sstemp_d5 int run return run function vve_examples:dice_10/regular/surface_5
execute if score cos int = sstemp_d6 int run return run function vve_examples:dice_10/regular/surface_6
execute if score cos int = sstemp_d9 int run return run function vve_examples:dice_10/regular/surface_7
execute if score cos int = sstemp_d8 int run return run function vve_examples:dice_10/regular/surface_8
execute if score cos int = sstemp_d9 int run return run function vve_examples:dice_10/regular/surface_9
execute if score cos int = sstemp_d10 int run return run function vve_examples:dice_10/regular/surface_10