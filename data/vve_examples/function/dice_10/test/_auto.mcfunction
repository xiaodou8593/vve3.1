#vve_examples:dice_10/test/_auto
# 自动化测试
# 以玩家为执行者
# 需要安装math3.1_gelib
...
data modify storage vve:io test_pointers set value [\
	"vve_examples:dice_10/test/cp/",\
	"vve_examples:dice_10/test/fall/",\
	"vve_examples:dice_10/test/push/",\
	"vve_examples:dice_10/test/float/",\
	"vve_examples:dice_10/test/inter_bounce/"\
]
