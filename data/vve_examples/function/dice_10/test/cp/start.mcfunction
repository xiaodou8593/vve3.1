#vve_examples:dice_10/test/cp/start
# 需要安装math3.1_gelib
...
# 设置测试程序主函数和销毁函数
data modify storage marker_control:io result.tick_func set value "vve_examples:dice_10/test/cp/main"
data modify storage marker_control:io result.del_func set value "vve_examples:dice_10/test/cp/end"
...
execute as @e[tag=result,limit=1] at @s positioned ~-0.5257311 ~1.618034 ~-0.8506508 run function vve:object/_rotate_here_as