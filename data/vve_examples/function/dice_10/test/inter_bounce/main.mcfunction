#vve_examples:dice_10/test/inter_bounce/main
...
#function vve_examples:dice_10/test/inter_bounce/store_frame with storage vve_examples:io {}

execute as @e[tag=vve_examples_dice_10,tag=test] run function vve_examples:dice_10/main_c
