#vve_examples:skip_stone/test/float/start
...
tag @e[tag=result,limit=1] remove skip_stone

execute as @e[tag=result,limit=1] run function marker_control:data/_get

# 设置测试程序主函数和销毁函数
data modify storage marker_control:io result.tick_func set value "vve_examples:skip_stone/test/float/main"
data modify storage marker_control:io result.del_func set value "vve_examples:skip_stone/test/float/end"
