#vve_examples:skip_stone/test/float/main
...
#function vve_examples:skip_stone/test/float/store_frame with storage vve_examples:io {}

function vve_examples:skip_stone/main_l
