#vve_examples:skip_stone/test/inter_bounce/main
...
#function vve_examples:skip_stone/test/inter_bounce/store_frame with storage vve_examples:io {}

execute as @e[tag=vve_examples_skip_stone,tag=test] run function vve_examples:skip_stone/main
