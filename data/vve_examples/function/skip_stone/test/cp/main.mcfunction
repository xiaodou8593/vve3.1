#vve_examples:skip_stone/test/cp/main
...
#function vve_examples:skip_stone/test/cp/store_frame with storage vve_examples:io {}
...
execute as 0-0-0-0-0 run function vve_examples:skip_stone/_iter_cpoints_render
# 运动同步
function vve_examples:skip_stone/_store
function vve_examples:skip_stone/main_sync
