#vve_examples:green_car/main_force
...
# 按键控制
execute on passengers on passengers run function vve_examples:green_car/control/get_signal
execute if entity @s[tag=vve_surface] run function vve_examples:green_car/control/main_surface
execute if entity @s[tag=!vve_surface] run function vve_examples:green_car/control/main_air
# 发动机引擎
