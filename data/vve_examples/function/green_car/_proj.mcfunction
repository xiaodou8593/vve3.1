#vve_examples:green_car/_proj
# 把数据模板投射到临时对象
# 输入数据模板storage vve_examples:io input

execute store result score wheel_state int run data get storage vve_examples:io input.wheel_state
execute store result score forward_power int run data get storage vve_examples:io input.control[0] 10000
execute store result score backward_power int run data get storage vve_examples:io input.control[1] 10000
execute store result score rotation_r int run data get storage vve_examples:io input.control[2] 10000
