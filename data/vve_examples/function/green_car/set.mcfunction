#vve_examples:green_car/set
# vve_examples:green_car/_new调用

execute store result score @s wheel_state run data get storage vve_examples:io input.wheel_state
execute store result score @s forward_power run data get storage vve_examples:io input.control[0] 10000
execute store result score @s backward_power run data get storage vve_examples:io input.control[1] 10000
execute store result score @s rotation_r run data get storage vve_examples:io input.control[2] 10000
