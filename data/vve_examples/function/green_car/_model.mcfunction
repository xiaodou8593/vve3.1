#vve_examples:green_car/_model
# 使用临时对象构建数据模板
# 输出数据模板storage vve_examples:io result

data modify storage vve_examples:io result set value {wheel_state:0, control:[0.0d, 0.0d, 0.0d], engine:[0.0d, 0.0d, 0.0d, 0.0d, 0.0d, 0.0d, 0.0d], mass:0, tensor:[0.0d, 0.0d, 0.0d, 0.0d, 0.0d, 0.0d], cube_shift_y:0, nvec:[0.0d, 0.0d, 0.0d], scale:[0.0d, 0.0d, 0.0d], center:[0.0d, 0.0d, 0.0d], velocity:[0.0d, 0.0d, 0.0d], angular_vec:[0.0d, 0.0d, 0.0d], angular_len:0, ivec:[0.0d, 0.0d, 0.0d], jvec:[0.0d, 0.0d, 0.0d], kvec:[0.0d, 0.0d, 0.0d], xyzw:[0.0d, 0.0d, 0.0d, 0.0d], start_xyzw:[0.0d, 0.0d, 0.0d, 0.0d], orth_xyzw:[0.0d, 0.0d, 0.0d, 0.0d], quat_phi:0}

execute store result storage vve_examples:io result.wheel_state int 1 run scoreboard players get wheel_state int
execute store result storage vve_examples:io result.control[0] double 0.0001 run scoreboard players get forward_power int
execute store result storage vve_examples:io result.control[1] double 0.0001 run scoreboard players get backward_power int
execute store result storage vve_examples:io result.control[2] double 0.0001 run scoreboard players get rotation_r int
