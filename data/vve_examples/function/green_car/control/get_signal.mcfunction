#vve_examples:green_car/control/get_signal
# vve_examples:green_car/control/main_c调用
...
execute on passengers run function vve_examples:green_car/control/get_signal_true