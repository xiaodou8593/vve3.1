#vve_examples:green_car/test/_auto
# 自动化测试
# 以玩家为执行者
# 需要安装math3.1_gelib
...
data modify storage vve:io test_pointers set value [\
	"vve_examples:green_car/test/cp/",\
	"vve_examples:green_car/test/fall/",\
	"vve_examples:green_car/test/push/",\
	"vve_examples:green_car/test/float/",\
	"vve_examples:green_car/test/inter_bounce/"\
]
