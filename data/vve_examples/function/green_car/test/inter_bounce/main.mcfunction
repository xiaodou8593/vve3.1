#vve_examples:green_car/test/inter_bounce/main
...
#function vve_examples:green_car/test/inter_bounce/store_frame with storage vve_examples:io {}

execute as @e[tag=vve_examples_green_car,tag=test] run function vve_examples:green_car/main_c
