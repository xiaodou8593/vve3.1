#vve_examples:green_car/test/push/main
...
#function vve_examples:green_car/test/push/store_frame with storage vve_examples:io {}

function vve_examples:green_car/main_c
scoreboard players set inp int 17500
