#vve_examples:dice_simulator/main_loop
# vve_examples:dice_simulator/main调用
...
execute as @e[tag=dice_8] run function vve_examples:dice_8/main_c
execute as @e[tag=dice_12] run function vve_examples:dice_12/main_c
...
execute if score global_rate int matches 1.. run function vve_examples:dice_simulator/main_loop
