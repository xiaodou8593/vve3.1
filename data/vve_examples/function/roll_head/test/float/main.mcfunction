#vve_examples:roll_head/test/float/main
...
#function vve_examples:roll_head/test/float/store_frame with storage vve_examples:io {}

function vve_examples:roll_head/main_l
