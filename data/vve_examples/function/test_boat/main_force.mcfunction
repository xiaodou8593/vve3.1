#vve_examples:test_boat/main_force
...
# 按键控制
execute on passengers on passengers run function vve_examples:test_boat/control/get_signal
execute if entity @s[tag=vve_surface] run function vve_examples:test_boat/control/main_surface
execute if entity @s[tag=!vve_surface] run function vve_examples:test_boat/control/main_air
# 发动机引擎
