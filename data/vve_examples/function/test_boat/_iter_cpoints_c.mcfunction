#vve_examples:test_boat/_iter_cpoints_c
# 遍历八个顶点作为碰撞点，进行介质探测
# 输出介质响应(各模块的临时对象)
...
scoreboard players operation buoyancy_h int = scale_v int
scoreboard players operation buoyancy_area int = scale_u int
scoreboard players operation buoyancy_area int /= 100 int
scoreboard players operation buoyancy_area int *= scale_w int
scoreboard players operation buoyancy_area int /= 3000 int
