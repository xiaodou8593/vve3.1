#vve_examples:test_boat/control/get_signal
# vve_examples:test_boat/control/main_c调用
...
execute on passengers run function vve_examples:test_boat/control/get_signal_true