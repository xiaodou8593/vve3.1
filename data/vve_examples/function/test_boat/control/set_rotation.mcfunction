#vve_examples:test_boat/control/set_rotation
# vve_examples:test_boat/control/main_water调用
# 设置水平旋转角速度
# 输入转弯半径<r,int,1w>
...
# 叠加前进俯仰角速度
execute if score input_w int matches 1 run function vve_examples:test_boat/control/add_phi

# 叠加横滚角速度
scoreboard players operation stemp_x int = kvec_x int
scoreboard players operation stemp_y int = kvec_y int
scoreboard players operation stemp_z int = kvec_z int
scoreboard players operation stemp_x int /= 6 int
scoreboard players operation stemp_y int /= 6 int
scoreboard players operation stemp_z int /= 6 int
scoreboard players operation stemp_x int *= sign int
scoreboard players operation stemp_y int *= sign int
scoreboard players operation stemp_z int *= sign int
scoreboard players operation angular_x int -= stemp_x int
scoreboard players operation angular_y int -= stemp_y int
scoreboard players operation angular_z int -= stemp_z int
