#vve_examples:test_boat/engine/main
...
execute if data storage vve:io shift_points[0] run scoreboard players set res int 1
execute if score material_response int matches -7 run scoreboard players set res int 1
execute if score res int matches 1 if score stemp_v int < v_max int run function vve_examples:test_boat/engine/gain_velocity