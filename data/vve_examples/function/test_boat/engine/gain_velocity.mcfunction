#vve_examples:test_boat/engine/gain_velocity
# vve_examples:test_boat/engine/main调用
...
execute if score temp_p int matches ..-1 run function vve_examples:test_boat/engine/backward_friction
