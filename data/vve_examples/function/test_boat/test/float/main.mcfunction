#vve_examples:test_boat/test/float/main
...
#function vve_examples:test_boat/test/float/store_frame with storage vve_examples:io {}

function vve_examples:test_boat/main_l
