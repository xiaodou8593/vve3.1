#vve_examples:test_boat/test/cp/main
...
#function vve_examples:test_boat/test/cp/store_frame with storage vve_examples:io {}
...
execute as 0-0-0-0-0 run function vve_examples:test_boat/_iter_cpoints_render
# 运动同步
function vve_examples:test_boat/_store
function vve_examples:test_boat/main_sync
