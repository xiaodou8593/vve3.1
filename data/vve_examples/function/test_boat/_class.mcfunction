#vve_examples:test_boat/_class
# 生成预设静态数据模板

function vve_examples:test_boat/_zero
...
data modify storage vve_examples:class test_boat_plate set from storage vve_examples:io result