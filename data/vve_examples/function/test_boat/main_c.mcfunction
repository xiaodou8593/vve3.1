...
# 介质探测
execute as 0-0-0-0-0 run function vve_examples:test_boat/_iter_cpoints_c
# 力学迭代
...
# 按键控制
execute on passengers run function vve_examples:test_boat/control/get_signal
execute if entity @s[tag=vve_surface] unless score material_response int matches -7 run function vve_examples:test_boat/control/main_surface
execute if score material_response int matches -7 run function vve_examples:test_boat/control/main_water
execute if entity @s[tag=!vve_surface] unless score material_response int matches -7 run function vve_examples:test_boat/control/main_air
# 发动机引擎
...
execute if score res int matches 1 run function vve_examples:test_boat/engine/main
# 运动同步
