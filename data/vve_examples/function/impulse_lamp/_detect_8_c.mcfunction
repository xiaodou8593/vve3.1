#vve_examples:impulse_lamp/_detect_8_c
...
execute at @s positioned ~-4.0 ~-4.0 ~-4.0 as @e[dx=7,dy=7,dz=7,tag=vve_cube_box,tag=vve_material_box] run function vve_examples:impulse_lamp/detect_point_c