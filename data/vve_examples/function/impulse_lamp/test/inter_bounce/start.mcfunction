#vve_examples:impulse_lamp/test/inter_bounce/start
...
execute as @e[tag=math_marker,limit=1] at @s positioned ~-1 ~3 ~ rotated 0.0 0.0 run function vve:object/_anchor_to
...
function vve_examples:impulse_lamp/_proj
execute as @e[tag=math_marker,limit=1] run function vve:test_coord/_topos
execute as @e[tag=math_marker,limit=1] at @s positioned ~ ~3 ~ rotated 0.0 0.0 run function vve:object/_anchor_to
function vve_examples:impulse_lamp/_model
data modify storage vve_examples:io input set from storage vve_examples:io result
data modify entity @e[tag=math_marker,limit=1] Pos set from storage vve_examples:io input.center
execute at @e[tag=math_marker,limit=1] run function vve_examples:impulse_lamp/_new
...
# 设置测试程序主函数和销毁函数
data modify storage marker_control:io result.tick_func set value "vve_examples:impulse_lamp/test/inter_bounce/main"
data modify storage marker_control:io result.del_func set value "vve_examples:impulse_lamp/test/inter_bounce/end"
