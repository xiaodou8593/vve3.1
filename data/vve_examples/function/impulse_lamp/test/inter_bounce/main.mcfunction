#vve_examples:impulse_lamp/test/inter_bounce/main
...
#function vve_examples:impulse_lamp/test/inter_bounce/store_frame with storage vve_examples:io {}

execute as @e[tag=vve_examples_impulse_lamp,tag=test] run function vve_examples:impulse_lamp/main_c
