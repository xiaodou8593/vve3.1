#vve_examples:impulse_lamp/test/point/start
# 需要安装math3.1_gelib

function vve:_consts
function vve_examples:impulse_lamp/init
scoreboard players set vve_examples_impulse_lamp_duration int 15
...
# 设置测试程序主函数和销毁函数
data modify storage marker_control:io result.tick_func set value "vve_examples:impulse_lamp/test/point/main"
data modify storage marker_control:io result.del_func set value "vve_examples:impulse_lamp/test/point/end"
