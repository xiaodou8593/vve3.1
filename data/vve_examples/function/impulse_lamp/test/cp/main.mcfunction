#vve_examples:impulse_lamp/test/cp/main
...
#function vve_examples:impulse_lamp/test/cp/store_frame with storage vve_examples:io {}
...
execute as 0-0-0-0-0 run function vve_examples:impulse_lamp/_iter_cpoints_render
# 运动同步
function vve_examples:impulse_lamp/_store
function vve_examples:impulse_lamp/main_sync
