#vve_examples:impulse_lamp/test/float/start
...
# 生成测试程序实体
data modify storage vve_examples:io input set from storage vve_examples:class impulse_lamp_plate
function vve_examples:impulse_lamp/_proj
...
# 设置测试程序主函数和销毁函数
data modify storage marker_control:io result.tick_func set value "vve_examples:impulse_lamp/test/float/main"
data modify storage marker_control:io result.del_func set value "vve_examples:impulse_lamp/test/float/end"
