#vve_examples:impulse_lamp/_model
# 使用临时对象构建数据模板
# 输出数据模板storage vve_examples:io result

data modify storage vve_examples:io result set value {light_duration:0, a:0, mass:0, inertia:0, cube_shift_y:0, nvec:[0.0d, 0.0d, 0.0d], scale:[0.0d, 0.0d, 0.0d], center:[0.0d, 0.0d, 0.0d], velocity:[0.0d, 0.0d, 0.0d], angular_vec:[0.0d, 0.0d, 0.0d], angular_len:0, ivec:[0.0d, 0.0d, 0.0d], jvec:[0.0d, 0.0d, 0.0d], kvec:[0.0d, 0.0d, 0.0d], xyzw:[0.0d, 0.0d, 0.0d, 0.0d], start_xyzw:[0.0d, 0.0d, 0.0d, 0.0d], orth_xyzw:[0.0d, 0.0d, 0.0d, 0.0d], quat_phi:0}

execute store result storage vve_examples:io result.light_duration int 1 run scoreboard players get light_duration int
