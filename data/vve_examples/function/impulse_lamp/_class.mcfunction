#vve_examples:impulse_lamp/_class
# 生成预设静态数据模板

function vve_examples:impulse_lamp/_zero
...
data modify storage vve_examples:class impulse_lamp_plate set from storage vve_examples:io result