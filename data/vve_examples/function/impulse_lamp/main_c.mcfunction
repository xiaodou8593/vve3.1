#vve_examples:impulse_lamp/main_c
...
scoreboard players operation temp_duration int = light_duration int
execute if score temp_duration int matches 0 run function vve_examples:impulse_lamp/main_off
execute if score temp_duration int matches 1.. run function vve_examples:impulse_lamp/main_on
