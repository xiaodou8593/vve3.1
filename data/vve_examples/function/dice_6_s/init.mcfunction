...
# 注册本模块
data modify storage module_control:io input set value {prefix:"vve_examples:dice_6_s/",namespace:"vve_examples"}
function module_control:data/_reg
scoreboard players operation #vve_examples:dice_6_s/ module_id = res int
...
function vve_examples:dice_6_s/_consts
