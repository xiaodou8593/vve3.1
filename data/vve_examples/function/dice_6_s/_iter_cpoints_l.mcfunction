#vve_examples:dice_6_s/_iter_cpoints_l
# 遍历顶点作为碰撞点，进行介质探测
# 输出介质响应(各模块的临时对象)
...
# 动态碰撞点
execute if score cube_shift_y int matches ..5000 run function vve_examples:dice_6_s/_detect_1_c
execute if score cube_shift_y int matches 5001..20000 run function vve_examples:dice_6_s/_detect_4_c
execute if score cube_shift_y int matches 20001..40000 run function vve_examples:dice_6_s/_detect_8_c
execute if score cube_shift_y int matches 40001.. run function vve_examples:dice_6_s/_detect_16_c
