#vve_examples:dice_6_s/test/float/main
...
#function vve_examples:dice_6_s/test/float/store_frame with storage vve_examples:io {}

function vve_examples:dice_6_s/main_l
