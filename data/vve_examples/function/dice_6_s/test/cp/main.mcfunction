#vve_examples:dice_6_s/test/cp/main
...
#function vve_examples:dice_6_s/test/cp/store_frame with storage vve_examples:io {}
...
execute as 0-0-0-0-0 run function vve_examples:dice_6_s/_iter_cpoints_render
# 运动同步
