#vve_examples:dice_6_s/test/inter_bounce/start
...
scoreboard players set inp int 30000
...
# 设置测试程序主函数和销毁函数
data modify storage marker_control:io result.tick_func set value "vve_examples:dice_6_s/test/inter_bounce/main"
data modify storage marker_control:io result.del_func set value "vve_examples:dice_6_s/test/inter_bounce/end"
