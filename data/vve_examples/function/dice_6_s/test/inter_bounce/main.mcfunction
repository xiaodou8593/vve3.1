#vve_examples:dice_6_s/test/inter_bounce/main
...
#function vve_examples:dice_6_s/test/inter_bounce/store_frame with storage vve_examples:io {}

execute as @e[tag=vve_examples_dice_6_s,tag=test] run function vve_examples:dice_6_s/main_c
