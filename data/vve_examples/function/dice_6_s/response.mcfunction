#vve_examples:dice_6_s/response
# vve_examples:dice_6_s/check_material调用
...
execute if entity @s[tag=vve_surface] run return run function vve_examples:dice_6_s/return_impulse
