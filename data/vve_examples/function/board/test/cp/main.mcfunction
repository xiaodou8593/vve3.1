#vve_examples:board/test/cp/main
...
#function vve_examples:board/test/cp/store_frame with storage vve_examples:io {}
...
execute as 0-0-0-0-0 run function vve_examples:board/_iter_cpoints_render
# 运动同步
function vve_examples:board/_store
function vve_examples:board/main_sync
