...
data modify storage vve:io test_pointers set value [\
	"vve_examples:board/test/cp/",\
	"vve_examples:board/test/fall/",\
	"vve_examples:board/test/push/",\
	"vve_examples:board/test/float/",\
	"vve_examples:board/test/inter_bounce/"\
]
