#vve_examples:slime_block/_proj
# 把数据模板投射到临时对象
# 输入数据模板storage vve_examples:io input

execute store result score damp_x int run data get storage vve_examples:io input.bounce[0]
execute store result score damp_v int run data get storage vve_examples:io input.bounce[1]
execute store result score damp_k int run data get storage vve_examples:io input.bounce[2]
execute store result score damp_b int run data get storage vve_examples:io input.bounce[3]
execute store result score damp_f int run data get storage vve_examples:io input.bounce[4]
