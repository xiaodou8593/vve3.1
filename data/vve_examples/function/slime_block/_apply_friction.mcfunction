#vve_examples:slime_block/_apply_friction
# 接收摩擦响应
...
scoreboard players operation damp_v int *= friction_response int
execute if score damp_v int matches ..-1 run scoreboard players add damp_v int 9999
