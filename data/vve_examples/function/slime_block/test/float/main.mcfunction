#vve_examples:slime_block/test/float/main
...
#function vve_examples:slime_block/test/float/store_frame with storage vve_examples:io {}

function vve_examples:slime_block/main_l
