#vve_examples:slime_block/test/_auto
# 自动化测试
# 以玩家为执行者
# 需要安装math3.1_gelib
...
data modify storage vve:io test_pointers set value [\
	"vve_examples:slime_block/test/cp/",\
	"vve_examples:slime_block/test/fall/",\
	"vve_examples:slime_block/test/push/",\
	"vve_examples:slime_block/test/float/",\
	"vve_examples:slime_block/test/inter_bounce/"\
]
