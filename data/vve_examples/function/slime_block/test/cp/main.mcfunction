#vve_examples:slime_block/test/cp/main
...
#function vve_examples:slime_block/test/cp/store_frame with storage vve_examples:io {}
...
execute as 0-0-0-0-0 run function vve_examples:slime_block/_iter_cpoints_render
# 运动同步
function vve_examples:slime_block/_store
function vve_examples:slime_block/main_sync
