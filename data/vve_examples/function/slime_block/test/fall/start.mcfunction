#vve_examples:slime_block/test/fall/start
...
scoreboard players set vve_grab_friction_tan int 10000
scoreboard players set vve_solid_friction_tan int 10000
# 使用函数y=1/(x+1)对比例x进行映射后得到的值
scoreboard players set vve_solid_bounce_inv int 5000
...
# 设置测试程序主函数和销毁函数
data modify storage marker_control:io result.tick_func set value "vve_examples:slime_block/test/fall/main"
data modify storage marker_control:io result.del_func set value "vve_examples:slime_block/test/fall/end"
