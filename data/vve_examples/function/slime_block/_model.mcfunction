#vve_examples:slime_block/_model
# 使用临时对象构建数据模板
# 输出数据模板storage vve_examples:io result

data modify storage vve_examples:io result set value {bounce:[0.0d, 0.0d, 0.0d, 0.0d, 0.0d], mass:0, tensor:[0.0d, 0.0d, 0.0d, 0.0d, 0.0d, 0.0d], scale:[0.0d, 0.0d, 0.0d], center:[0.0d, 0.0d, 0.0d], velocity:[0.0d, 0.0d, 0.0d], angular_vec:[0.0d, 0.0d, 0.0d], angular_len:0, ivec:[0.0d, 0.0d, 0.0d], jvec:[0.0d, 0.0d, 0.0d], kvec:[0.0d, 0.0d, 0.0d], xyzw:[0.0d, 0.0d, 0.0d, 0.0d], start_xyzw:[0.0d, 0.0d, 0.0d, 0.0d], orth_xyzw:[0.0d, 0.0d, 0.0d, 0.0d], quat_phi:0}

execute store result storage vve_examples:io result.bounce[0] double 1 run scoreboard players get damp_x int
execute store result storage vve_examples:io result.bounce[1] double 1 run scoreboard players get damp_v int
execute store result storage vve_examples:io result.bounce[2] double 1 run scoreboard players get damp_k int
execute store result storage vve_examples:io result.bounce[3] double 1 run scoreboard players get damp_b int
execute store result storage vve_examples:io result.bounce[4] double 1 run scoreboard players get damp_f int
