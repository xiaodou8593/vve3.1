#vve_examples:slime_block/set
# vve_examples:slime_block/_new调用

execute store result score @s damp_x run data get storage vve_examples:io input.bounce[0]
execute store result score @s damp_v run data get storage vve_examples:io input.bounce[1]
execute store result score @s damp_k run data get storage vve_examples:io input.bounce[2]
execute store result score @s damp_b run data get storage vve_examples:io input.bounce[3]
execute store result score @s damp_f run data get storage vve_examples:io input.bounce[4]
