#vve_examples:domino/test/_auto
# 自动化测试
# 以玩家为执行者
# 需要安装math3.1_gelib
...
data modify storage vve:io test_pointers set value [\
	"vve_examples:domino/test/cp/",\
	"vve_examples:domino/test/fall/",\
	"vve_examples:domino/test/push/",\
	"vve_examples:domino/test/float/",\
	"vve_examples:domino/test/inter_bounce/"\
]
