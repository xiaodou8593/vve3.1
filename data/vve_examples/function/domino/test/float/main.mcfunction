#vve_examples:domino/test/float/main
...
#function vve_examples:domino/test/float/store_frame with storage vve_examples:io {}

function vve_examples:domino/main_l
