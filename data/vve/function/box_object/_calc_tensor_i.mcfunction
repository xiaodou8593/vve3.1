...
scoreboard players operation tensor_xx int /= inp int
...
scoreboard players operation tensor_yy int /= inp int
...
scoreboard players operation tensor_zz int /= inp int
