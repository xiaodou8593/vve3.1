...
# 计算叉乘
function math:vec/_cross_fvec_high_trunc
...
scoreboard players operation sstemp_0 int = inertia int
scoreboard players remove sstemp_0 int 1
execute if score sstemp_x int matches ..-1 run scoreboard players operation sstemp_x int += sstemp_0 int
execute if score sstemp_y int matches ..-1 run scoreboard players operation sstemp_y int += sstemp_0 int
execute if score sstemp_z int matches ..-1 run scoreboard players operation sstemp_z int += sstemp_0 int
scoreboard players operation sstemp_x int /= inertia int
scoreboard players operation sstemp_y int /= inertia int
scoreboard players operation sstemp_z int /= inertia int
