...
scoreboard players operation u int += sstemp_n1_x int
scoreboard players operation v int += sstemp_n1_y int
scoreboard players operation w int += sstemp_n1_z int
