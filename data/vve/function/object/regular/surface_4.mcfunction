...
scoreboard players operation u int += sstemp_n4_x int
scoreboard players operation v int += sstemp_n4_y int
scoreboard players operation w int += sstemp_n4_z int
