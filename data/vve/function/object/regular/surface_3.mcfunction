...
scoreboard players operation u int += sstemp_n3_x int
scoreboard players operation v int += sstemp_n3_y int
scoreboard players operation w int += sstemp_n3_z int
