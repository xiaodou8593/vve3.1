...
scoreboard players operation u int += sstemp_n12_x int
scoreboard players operation v int += sstemp_n12_y int
scoreboard players operation w int += sstemp_n12_z int
