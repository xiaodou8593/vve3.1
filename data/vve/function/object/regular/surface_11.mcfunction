...
scoreboard players operation u int += sstemp_n11_x int
scoreboard players operation v int += sstemp_n11_y int
scoreboard players operation w int += sstemp_n11_z int
