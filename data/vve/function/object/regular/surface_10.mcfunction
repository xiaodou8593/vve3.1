...
scoreboard players operation u int += sstemp_n10_x int
scoreboard players operation v int += sstemp_n10_y int
scoreboard players operation w int += sstemp_n10_z int
