...
scoreboard players operation u int += sstemp_n8_x int
scoreboard players operation v int += sstemp_n8_y int
scoreboard players operation w int += sstemp_n8_z int
