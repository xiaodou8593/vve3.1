...
scoreboard players operation u int += sstemp_n6_x int
scoreboard players operation v int += sstemp_n6_y int
scoreboard players operation w int += sstemp_n6_z int
