...
scoreboard players operation u int += sstemp_n2_x int
scoreboard players operation v int += sstemp_n2_y int
scoreboard players operation w int += sstemp_n2_z int
