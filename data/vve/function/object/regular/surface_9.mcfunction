...
scoreboard players operation u int += sstemp_n9_x int
scoreboard players operation v int += sstemp_n9_y int
scoreboard players operation w int += sstemp_n9_z int
