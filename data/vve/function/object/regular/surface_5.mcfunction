...
scoreboard players operation u int += sstemp_n5_x int
scoreboard players operation v int += sstemp_n5_y int
scoreboard players operation w int += sstemp_n5_z int
