...
scoreboard players set material_response int -7

# 摩擦系数
scoreboard players operation friction_response int = vve_water_friction int
...
scoreboard players operation impulse_fy int *= vve_water_c int
