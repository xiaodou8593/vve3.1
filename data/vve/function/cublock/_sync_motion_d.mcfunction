...
execute store result storage vve:io x double 0.0001 run scoreboard players get x int
execute store result storage vve:io y double 0.0001 run scoreboard players operation sstemp_y int -= cube_shift_y int
execute store result storage vve:io z double 0.0001 run scoreboard players get z int
execute positioned 0.0 0.0 0.0 rotated 0.0 0.0 run function vve:cublock/sync_motion_d with storage vve:io {}