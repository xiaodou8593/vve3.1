...
scoreboard players operation uvec_x int *= kvec_x int
scoreboard players operation uvec_y int *= kvec_y int
scoreboard players operation uvec_z int *= kvec_z int
scoreboard players operation uvec_x int += uvec_y int
scoreboard players operation uvec_x int += uvec_z int
execute if score uvec_x int matches ..-1 run scoreboard players set sstemp_sign int -1
scoreboard players operation uvec_x int = kvec_x int
scoreboard players operation uvec_y int = kvec_y int
scoreboard players operation uvec_z int = kvec_z int
scoreboard players operation uvec_x int *= sstemp_sign int
scoreboard players operation uvec_y int *= sstemp_sign int
scoreboard players operation uvec_z int *= sstemp_sign int
