#vve:test/sound/_proj
# 把数据模板投射到临时对象
# 输入数据模板storage vve:io input

execute store result score vve_sound_timer int run data get storage vve:io input.vve_sound_timer
execute store result score vve_last_material int run data get storage vve:io input.vve_last_material
