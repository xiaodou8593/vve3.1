#vve:test/explode/block/main
# vve:test/explode/block/tick调用
# 实体对象主程序

tag @s remove vve_material_box
function vve:test/explode/block/_get
# 运动学迭代
...
# 运动同步
function vve:test/explode/block/_sync_motion
function vve:test/explode/block/_store
