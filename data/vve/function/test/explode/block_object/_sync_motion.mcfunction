#vve:test/explode/block_object/_sync_motion
# 提供explode_block_object实体运动同步方案
...
execute store result storage math:io translation[1] float -0.0001 run scoreboard players get fvec_y int
