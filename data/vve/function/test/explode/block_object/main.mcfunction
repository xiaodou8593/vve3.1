#vve:test/explode/block_object/main
# vve:test/explode/block_object/tick调用
# 实体对象主程序
...
# 介质探测
execute as 0-0-0-0-0 run function vve:test/explode/block_object/_iter_cpoints_c
# 力学迭代
...
# 运动同步
function vve:test/explode/block_object/_sync_motion
