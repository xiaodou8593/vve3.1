...
# 设置测试程序主函数和销毁函数
data modify storage marker_control:io result.tick_func set value "vve:block/test/ball/main"
data modify storage marker_control:io result.del_func set value "vve:block/test/ball/end"
