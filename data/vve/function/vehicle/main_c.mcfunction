...
# 按键控制
execute on passengers on passengers run function vve:vehicle/control/get_signal
execute if entity @s[tag=vve_surface] run function vve:vehicle/control/main_surface
execute if entity @s[tag=!vve_surface] run function vve:vehicle/control/main_air
# 发动机引擎
