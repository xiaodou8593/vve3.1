...
# 注册本模块
data modify storage module_control:io input set value {prefix:"vve:slope_zp/",namespace:"vve"}
function module_control:data/_reg
scoreboard players operation #vve:slope_zp/ module_id = res int
...
function vve:slope_zp/_consts

function vve:slope_zp/_class