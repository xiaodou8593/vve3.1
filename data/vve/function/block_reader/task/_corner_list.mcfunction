#vve:block_reader/task/_corner_list
# 根据对角线确定立方体添加任务
...
data modify storage vve:io stemp set value []
...
data modify storage vve:io result set from storage vve:io stemp
data modify storage vve:io result[-1].over_func set from storage vve:io over_func