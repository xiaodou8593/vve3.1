#vve:ball_object/test/inter_bounce/main
...
#function vve:ball_object/test/inter_bounce/store_frame with storage vve:io {}

execute as @e[tag=vve_ball_object,tag=test] run function vve:ball_object/main_c
