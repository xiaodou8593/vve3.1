...
data modify storage vve:io test_pointers set value [\
	"vve:ball_object/test/cp/",\
	"vve:ball_object/test/fall/",\
	"vve:ball_object/test/push/",\
	"vve:ball_object/test/float/",\
	"vve:ball_object/test/inter_bounce/"\
]
