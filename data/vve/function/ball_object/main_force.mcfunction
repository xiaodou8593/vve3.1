#vve:ball_object/main_force
# vve:ball_object/tick调用
# 实体对象力学迭代主程序

function vve:ball_object/_get
# 介质探测
execute as 0-0-0-0-0 run function vve:ball_object/_iter_cpoints_c
# 力学迭代
...
# 姿态角速度修正
execute if score grab_layer_response int matches 3.. if score grab_layer_receiver_v_norm int < grab_layer_regular_v int as 0-0-0-0-0 run function vve:ball_object/_regular
