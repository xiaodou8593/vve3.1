#vve:ball_object/init
# 初始化ball_object模块


scoreboard objectives add vve_ball_r dummy
...
function vve:ball_object/_consts

function vve:ball_object/_class

function vve:ball_object/init_operation