...
scoreboard players operation stemp_x int *= -1 int
scoreboard players add stemp_x int 10000
...
execute if score stemp_depth_xy int = stemp_depth int run return fail
execute if score stemp_depth_xz int = stemp_depth int run return run scoreboard players operation nvec_y int >< nvec_z int
execute if score stemp_depth_yz int = stemp_depth int run return run scoreboard players operation nvec_x int >< nvec_z int