#vve:solid_box/detect_ball_inside_z
...
execute if score sstemp_sz int matches ..-1 run scoreboard players set nvec_z int -10000

scoreboard players operation grab_depth int = vve_ball_r int
scoreboard players operation grab_depth int -= sstemp_dz int
